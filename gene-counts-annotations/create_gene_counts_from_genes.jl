...
create_gene_counts_file(create_input("./gene-counts-annotations/gene_annotations.csv"), "./gene-counts-annotations/pre_processing_gene_counts.csv", 0)

remove_past_dec("./gene-counts-annotations/pre_processing_gene_counts.csv", "./gene-counts-annotations/in_processing_gene_counts.csv", 16)

drop_duplicates("./gene-counts-annotations/in_processing_gene_counts.csv", "./gene-counts-annotations/gene_counts.csv", "gene_id")