...
plotMA(resLFC, ylim=c(-2, 2), main="Log2 fold change of normalized gene counts:\nZIKV infected vs. uninfected") # plot the log2 fold change for the mean of the normalized counts of all the samples in the gene count DESeq analysis results table post-shrinkage
