...
write.csv(as.data.frame(resOrdered),
	  file="./deseq/denv-deseq/DENV_infected_results.csv") # write the ordered results as a dataframe to a csv file
...
write.csv(as.data.frame(resSig),
	  file="./deseq/denv-deseq/DENV_infected_results_significant.csv") # write the significant ordered results as a data frame to a csv file
...
if(file.exists("./Rplots.pdf")){
	file.rename(from="./Rplots.pdf", to="./deseq/denv-deseq/Rplots.pdf")
}
