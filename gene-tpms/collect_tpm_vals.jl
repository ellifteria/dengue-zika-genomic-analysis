...
create_gene_tpm_file(create_input("./gene-counts-annotations/gene_annotations.csv"), "./gene-tpms/pre_processing_gene_tpm.csv", 0)

remove_past_dec("./gene-tpms/pre_processing_gene_tpm.csv", "./gene-tpms/in_processing_gene_tpm_1.csv", 16)

drop_duplicates("./gene-tpms/in_processing_gene_tpm_1.csv", "./gene-tpms/in_processing_gene_tpm_2.csv", "gene_id")

norm_log2("./gene-tpms/in_processing_gene_tpm_2.csv", "./gene-tpms/in_processing_gene_tpm_3.csv")

keep_cross_reference("./gene-tpms/in_processing_gene_tpm_3.csv", "./gene-ontology/all_sig_genes.txt", "./gene-tpms/final_gene_tpm.csv")